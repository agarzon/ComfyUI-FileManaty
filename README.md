...
- 📤 **Full write operations** — create folders, rename, upload **files or whole folders** (button or drag from your desktop, with a progress bar), copy/cut/paste, and move — within and across roots.
