...
| `write.max_upload_mb` | no | `1024` | Max size per uploaded file, `1`–`1048576`. Counted in MiB — the value is multiplied by `1024 * 1024` — so the default is 1 GiB and the ceiling is 1 TiB. See [Uploading big files](#uploading-big-files) |
